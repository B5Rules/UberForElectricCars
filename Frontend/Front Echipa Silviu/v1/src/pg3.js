                  ...
                  <View style={styles.containerJos}>
                    ...
                    <View style={styles.containerJos1}>
                      ...
                      <View style={styles.containerJos1Texte}>
                        ...
                        <View style={styles.containerJos1Linie}>
                          <Text style={styles.text5}>Numar km:</Text><Text style={styles.text4}>BMW</Text>
                        </View>
                        <View style={styles.containerJos1Linie}>
                          <Text style={styles.text5}>Capacitate baterie:</Text><Text style={styles.text4}>BMW</Text>
                        </View>
                        <View style={styles.containerJos1Linie}>
                          <Text style={styles.text5}>Cai putere:</Text><Text style={styles.text4}>BMW</Text>
                        </View>
